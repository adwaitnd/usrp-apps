...
public:
	CallbackHelper(mqtt::async_client& cli, mqtt::connect_options& connOpts)
				: nretry_(0), cli_(cli), connOpts_(connOpts) {}
};

/////////////////////////////////////////////////////////////////////////////

void mqtt_pubsub_ops(std::string server, std::string userid, std::string pubtopic, std::string subtopic, ProtectedQ<std::string> *toNetwork, ProtectedQ<std::string> *fromNetwork)
{
	...
	mqtt::topic topic { client, subtopic, QOS };
