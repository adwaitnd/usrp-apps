...
int main(int argc, char* argv[])
{
	...
	try {
		...
		cout << "keep alive interval:" << connOpts.get_keep_alive_interval().count() << endl;

		cout << "connecton timeout:" << connOpts.get_connect_timeout().count() << endl;

		cout<< "retry interval: " << connOpts.get_min_retry_interval().count() << " to " << connOpts.get_max_retry_interval().count() <<endl;
